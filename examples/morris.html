...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../pages/views/inicio.php">SB Admin v2.0</a>
            </div>
            <!-- /.navbar-header -->
            <? include("../pages/views/inc/menuh.php") ?>
            <!-- /.navbar-top-links -->
            <? include("../pages/views/inc/menuv.php") ?>
            <!-- /.navbar-static-side -->
        </nav>
    ...
    <script src="../resources/scripts/data/morris-data.js"></script>
