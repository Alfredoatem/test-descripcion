;(function (global, factory) {
    ...
    hooks.defineLocale('es', {
        ...
        weekdays : 'domingo_lunes_martes_miercoles_jueves_viernes_sabado'.split('_'), /*mié - sá convertido*/
        weekdaysShort : 'dom._lun._mar._mie._jue._vie._sab.'.split('_'), /*mié - sá convertido*/
        weekdaysMin : 'do_lu_ma_mi_ju_vi_sa'.split('_'), /*mié - sá convertido*/
        weekdaysParseExact : true,
        longDateFormat : {
            LT : 'H:mm',
            LTS : 'H:mm:ss',
