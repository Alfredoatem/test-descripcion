...
if($_POST){	
  ...
  if($txtfini!="" && $txtffin!="" ){
  	...
  	header('Location:pdfrepg.php?criterio='.base64_encode($criterio).'&fini='.$txtfini.'&ffin='.$txtffin.'&crifec='.$crifech);	
}
?>
<!DOCTYPE html>
<html>
...
<div id="wrapper"> 
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      <a class="navbar-brand" href="views/inicio.php">Reporte de Movimiento Ingresos y Salidas de Almacenes</a>
    </div>
    <!-- /.navbar-header -->
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header">Reporte de Movimiento Ingresos y Salidas de Almacenes </h3>
      </div>
      <!-- /.col-lg-12 --> 
    </div>
    <!-- /.row -->
    <div class="row">
      <form role="form" class="form-horizontal" action="formrepg.php" method="post" target="_blank">
        <div class="col-lg-12">
