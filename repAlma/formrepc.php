...
if($_POST){	
  ...
  if($cbotipper!=""){
  	...
  	header('Location:pdfrepc.php?criterio='.base64_encode($criterio).'&orden='.$cborden.'&crifvenc='.$cbofvenc.'&frep='.$txtfini);	
}
?>
<!DOCTYPE html>
<html>
...
<div id="wrapper"> 
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      <a class="navbar-brand" href="views/inicio.php">Inventario Valorado nivel Almacen </a>
    </div>
    <!-- /.navbar-header -->
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header">Inventario Valorado nivel Almacen </h3>
      </div>
      <!-- /.col-lg-12 --> 
    </div>
    <!-- /.row -->
    <div class="row">
      <form role="form" class="form-horizontal" action="formrepc.php" method="post" target="_blank">
        <div class="col-lg-12">
