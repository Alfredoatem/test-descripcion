...
if($_POST){	
  ...
  if($txtrevisor!=""){
	...
	header('Location:pdfrep6.php?criterio='.base64_encode($criterio).'&orden='.$cborden);	
}
?>
<!DOCTYPE html>
<html>
...
<div id="wrapper"> 
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header">Cargo y Descargo SIGEP - Pasajes y Viaticos</h3>
      </div>
      <!-- /.col-lg-12 --> 
    </div>
    <!-- /.row -->
    <div class="row">
      <form role="form" class="form-horizontal" action="formcrirep6.php" method="post" target="_blank">
        <div class="col-lg-8">
