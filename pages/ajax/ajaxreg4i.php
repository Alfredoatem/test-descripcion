...
try {
    ...
    $sql.= "'$txtfecha','$txtglosa','$hdnrepar','$txtemp','$txtdocent','$txtsolpor','','','$txthtd','$cboffin','$cboofin','','',";
    $sql.= "'".$_SESSION["sialmausr"]."','".date('m/d/Y')."','".$_SESSION["sialmausr"]."','".date('m/d/Y')."','','','$txtgest');";
    //echo $sql."<br>";
