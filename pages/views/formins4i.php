...
<? include("inc/header.php") ?>
    ...
    <script src="../js/formins4i.js"></script>
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input name="txtdocent" class="form-control" id="txtdocent" maxlength="25" required>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-lg-1 control-label">Org.Fin.</label>
                      <div class="col-lg-5">
                          ...
                          <input type="hidden" name="hdnselofin" id="hdnselofin" >
                      </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) --> 
