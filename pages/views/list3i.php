...
//        $sqlpyv="SELECT * FROM pyvsigep WHERE gestion='".$row['gestion']."' AND nro='".$row['nro']."'";
        ...
        <nav aria-label="Page navigation">
          ...
          if($tpaginas > 1) {
            ...
            ?>
              <li class="<?=$disableprev?>"><a href="list3i.php?pagina=<?="0".$link;?>"><span aria-hidden="true">&larr;</span> Primero</a></li>
              <li class="<?=$disableprev?>"><a href="list3i.php?pagina=<?=($pagina-1).$link;?>">Anterior</a></li>
              <li class="<?=$disablenext?>"><a href="list3i.php?pagina=<?=($pagina+1).$link;?>">Siguiente</a></li>
              <li class="<?=$disablenext?>"><a href="list3i.php?pagina=<?=$tpaginas.$link;?>">Ultimo <span aria-hidden="true">&rarr;</span></a></li>
            <?
          }
          ?>
          </ul>
