  ...
  <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Transacci&oacute;n de Ingresos
                    ...
                    <div class='pull-right'>
                        <div class='btn-group' role="group">
                            ...
                            <a href="../reportes/reporterecibo.php?documento=<?=base64_encode($row['dcto'].','.$row['nro'].','.$row['gestion'])?>" class="btn btn-default" target="_blank"><span class="fa fa-print"></span>&nbsp;Imprimir</a>
                        </div>
                    </div>
                    <!--//////////////////////////////////////////////////////////////////////////////////////////////-->
                </h2>      
                ...
                <!--<form action="buscar4.php" method='GET'>
        ...
        <!-- /.row -->
        <div class="row">
            <form role="form" action="" class="form-horizontal" id="formajax" method="POST">
            <div class="col-lg-12">
                <div id="message"></div>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                if($tpaginas > 1) {
                    ...
                    ?>
                    <!--<li class="<?//=$disableprev?>"><a href="index.php?pagina=<?//="0".$link;?>"><span aria-hidden="true">&larr;</span> Primero</a></li>
                    <li class="<?//=$disableprev?>"><a href="index.php?pagina=<?//=($pagina-1).$link;?>">Anterior</a></li>
                    <li class="<?//=$disablenext?>"><a href="index.php?pagina=<?//=($pagina+1).$link;?>">Siguiente</a></li>
                    <li class="<?//=$disablenext?>"><a href="index.php?pagina=<?//=$tpaginas.$link;?>">Ultimo <span aria-hidden="true">&rarr;</span></a></li>-->
            ...
            <button type="button" onclick="location.href='index.php'" class="btn btn-lg btn-primary btn-volver">Volver</button>
