...
<html>
  <head>
    ...
    <script src="../js/list1s.js" charset="UTF-8"></script>
    <style>
      .pagination{
        margin:0px 0;
      }
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <div class="col-lg-7">
                          <input name="txtresp" type="text" class="form-control" id="txtresp" maxlength="50" value="<?=trim($row['ref3'])?>">
                        </div>
...
//        $sqlpyv="SELECT * FROM pyvsigep WHERE gestion='".$row['gestion']."' AND nro='".$row['nro']."'";
        ...
        <nav aria-label="Page navigation">
          ...
          if($tpaginas > 1) {
            ...
            ?>
              <li class="<?=$disableprev?>"><a href="list1s.php?pagina=<?="0".$link;?>"><span aria-hidden="true">&larr;</span> Primero</a></li>
              <li class="<?=$disableprev?>"><a href="list1s.php?pagina=<?=($pagina-1).$link;?>">Anterior</a></li>
              <li class="<?=$disablenext?>"><a href="list1s.php?pagina=<?=($pagina+1).$link;?>">Siguiente</a></li>
              <li class="<?=$disablenext?>"><a href="list1s.php?pagina=<?=$tpaginas.$link;?>">Ultimo <span aria-hidden="true">&rarr;</span></a></li>
            <?
          }
          ?>
          </ul>
