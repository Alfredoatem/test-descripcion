...
<div id="wrapper"> 
  ...
  <div id="page-wrapper">
    ...
    <!-- /.row -->
    <div class="row">
      <form role="form" action="update.php" class="form-horizontal" method="POST">
        <div class="col-lg-12">
          <div id="message"></div>
              ...
              <div class="row">
                  ...
                  <label class="col-lg-1 control-label">Fecha Verificaci&oacute;n</label>
                    <div class="col-lg-3">
                      <div class='input-group date' id='txtfechav'>
                        <input type='text' class="form-control" name="txtfechav" placeholder="<?=newdate($row['fecha_v'])?>" value="<?=newdate($row['fecha_v'])?>" required/>
                    ...
                    <div class="col-lg-3">
                      <div class='input-group date' id='txtfechadep'>
                        <input type='text' class="form-control" name="txtfechadep" placeholder="<?=newdate($row['fecha_dep'])?>" value="<?=newdate($row['fecha_dep'])?>" required/>
                        <span class="input-group-addon">
                          <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                      </div>
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input name="txtinter" class="form-control" maxlength="100" id="txtinter" value="<?=$row['inter']?>"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                    </div>
                  </div>
                  <div class="form-group">
                        <label class="col-lg-1 control-label">Observaciones:</label>
                        <div class="col-lg-11">
                          <input name="txtobs" class="form-control" id="txtobs" value="<?=$row['obs']?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtpreventivo" class="form-control" id="txtpreventivo" value="<?=$row['preventivo']?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  ...
                  <label class="col-lg-1 control-label">Fecha A.:</label>
                    ...
                    <div class="col-lg-5">
                      <input name="txtobsa" class="form-control" id="txtobsa" value="<?=$row['obsa']?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                  </div>
                </div>
              </div>
