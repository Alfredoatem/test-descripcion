...
$sql="SELECT * FROM ingteso WHERE inter like '%".$busqueda."%' or obs like '%".$busqueda."%' ";
                                        ...
                                        <div class="form-group" style="padding: 0px 25px 0px 25px;">
                                            <div class='pull-right'>
                                                <div class='btn-group' role="group">
                                                    <a href="modificabus.php?nro=<?=$busqueda?>" class="btn btn-success"><span class="fa fa-edit"></span>&nbsp;Editar</a>
