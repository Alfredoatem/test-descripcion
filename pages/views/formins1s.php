...
<? include("inc/header.php") ?>
    ...
    <script>
        $(function(){
            ...
            $(".txtpu").number(true,7,'.','');
            //console.log($(".hdncodprod").val());
            enlace();
        });
    </script>
    <script src="../js/formins1s.js"></script>
      ...
      <form role="form" class="form-horizontal registro" id="form">
        <div class="col-lg-12">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-lg-1 control-label">Fuente</label>
                      <div class="col-lg-3">
                          ...
                          <input type="hidden" name="hdnselffin" id="hdnselffin" >
                      </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtpedi" class="form-control" id="txtpedi" maxlength="10" required>
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-7">
                      <input name="txtresp" class="form-control" id="txtresp" maxlength="50" required>
                    </div>
                    <label class="col-lg-1 control-label">Tipo.Per.</label>
                      <div class="col-lg-3">
                          <select name="cbotiper" id="cbotiper" class="form-control" required>
                          </select>
                          <input type="hidden" id="hdncodgranalm" name="hdncodgranalm" class="hdncodgranalm" value="<?=$_SESSION['sialmagalm']?>"/>
                      </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) --> 
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table id="parameters" class="table table-borderless">
                    <thead>
                    <tr>
