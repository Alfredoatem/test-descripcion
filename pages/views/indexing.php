...
//$sql="SELECT count(*) as num FROM ingteso WHERE dcto='I' ";
//$sql="SELECT count(*) as num FROM ingteso WHERE dcto='I' and (inter like '%$busqueda%' or codcta like '%$busqueda%' or codcon like '%$busqueda%' or cta like '%$busqueda%' or obs like '%$busqueda%' or repar like '%$busqueda%' or dcto_c like '%$busqueda%' or estado like '%$busqueda%' or obsa like '%$busqueda%' or programa like '%$busqueda%' or clase like '%$busqueda%' or rubro like '$$busqueda$' or ffin like '%$busqueda%' or gestprev like '%$busqueda%' or preventivo like '%$busqueda%')";
...
//$sql="SELECT skip $inicio first $registros * FROM ingteso WHERE dcto='I'";
//$sql="SELECT skip $inicio first $registros * FROM ingteso WHERE dcto='I' and (inter like '%$busqueda%' or codcta like '%$busqueda%' or codcon like '%$busqueda%' or cta like '%$busqueda%' or obs like '%$busqueda%' or repar like '%$busqueda%' or dcto_c like '%$busqueda%' or estado like '%$busqueda%' or obsa like '%$busqueda%' or programa like '%$busqueda%' or clase like '%$busqueda%' or rubro like '$$busqueda$' or ffin like '%$busqueda%' or gestprev like '%$busqueda%' or preventivo like '%$busqueda%')";
  ...
  <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div>
                    <div class="pull-left" style="float:right; padding:30px 0 0 0;"><b><?echo $tpaginas;?></b> Resultado(s) encontrado(s).</div>
                    <div class="row right" style="float:right; padding:20px 0 0 0;">
                        <div class="col-lg-12">
                            <form action="" method="GET" class="form-search">
                                    ...
                                    <button type="submit" id="enviar" name="enviar" class="btn btn-primary"><img src="data:image/png;base64,"/> Buscar</button>
                            </form>
                        </div>
                    </div>
                </div>   
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-11">
                                                <input name="txtinter" class="form-control" maxlength="100" id="txtinter" value="<?=$row['inter']?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-1 control-label">Observaciones:</label>
                                            <div class="col-lg-11">
                                                <input name="txtobs" class="form-control" id="txtobs" data-toggle="tooltip" data-placement="bottom" value="<?=$row['obs']?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.col-lg-12 (nested) -->
        ...
        <nav aria-label="Page navigation">
            ...
            <button type="button" onclick="location.href='indexing.php'" class="btn btn-lg btn-primary btn-volver">Volver</button>
