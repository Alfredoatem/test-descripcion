...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sqls="SELECT MAX(nro) as nums FROM ingteso where dcto='$dcto'";
...
<div id="wrapper"> 
  ...
  <div id="page-wrapper">
    ...
    <!-- /.row -->
    <div class="row">
      <form role="form" action="regingajax.php" class="form-horizontal" method="POST">
        <div class="col-lg-12">
          <div id="message"></div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtgestion" class="form-control llaves" id="txtgestion" type="text" value="" maxlength="4" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required>
                    </div>
                    <label class="col-lg-1 control-label">Dcto.:</label>
                    <div class="col-lg-3">
                      <input name="txtdcto" class="form-control llaves" id="txtdcto" maxlength="1" value="<?=$row['dcto']?>" readonly required>
                    </div>
                    <label class="col-lg-1 control-label">Nro.:</label>
                    <div class="col-lg-3">
                      <input name="txtnro" class="form-control llaves" id="txtnro" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?=$rows['nums']+1?>" readonly required>
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  ...
                  <label class="col-lg-1 control-label">Fecha Verificaci&oacute;n</label>
                    ...
                    <div class="col-lg-3">
                      <input name="txtopbanco" class="form-control" id="txtopbanco" maxlength="8" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="" required>
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-11">
                      <input name="txtinter" class="form-control" maxlength="50" id="txtinter" value="" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                    </div>
                  </div>
                  <div class="form-group">
                        <label class="col-lg-1 control-label">Observaciones:</label>
                        <div class="col-lg-11">
                          <input name="txtobs" class="form-control" id="txtobs" value="" maxlength="50" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtcodcon" class="form-control" id="txtcodcon" value="" maxlength="5" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">Cod.Cuenta Bancaria:</label>
                    <div class="col-lg-3">
                      <input name="txtcodcta" class="form-control" id="txtcodcta" value="" maxlength="6" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">Cod. Reparici&oacute;n:</label>
                    <div class="col-lg-3">
                      <input name="txtrepar" class="form-control" id="txtrepar" value="" maxlength="6" style="text-transform:uppercase;">
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtdctoc" class="form-control" id="txtdctoc"value="" maxlength="1" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">Programa</label>
                    <div class="col-lg-3">
                      <input name="txtprograma" class="form-control" id="txtprograma"value="" maxlength="2" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">monto</label>
                    <div class="col-lg-3">
                      <input name="txtmonto" class="form-control" id="txtmonto" value="" maxlength="15" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required>
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtcta" class="form-control" id="txtcta" value="" maxlength="6" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">Actividad:</label>
                    <div class="col-lg-3">
                      <input name="txtclase" class="form-control" id="txtclase"  value="" maxlength="2" style="text-transform:uppercase;">
                    </div>
                    <label class="col-lg-1 control-label">Rubro:</label>
                    <div class="col-lg-3">
                      <input name="txtrubro" class="form-control" id="txtrubro"  value="" maxlength="5" style="text-transform:uppercase;">
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <input name="txtestado" class="form-control" id="txtestado" value="" maxlength="1" style="text-transform:uppercase;" >
                    </div>
                    <label class="col-lg-1 control-label">Fuente Fin:</label>
                    <div class="col-lg-3">
                      <input name="txtffin" class="form-control" id="txtffin"  value="" maxlength="5" style="text-transform:uppercase;" required>
                    </div>
                    <label class="col-lg-1 control-label">Preventivo:</label>
                    <div class="col-lg-3">
                      <input name="txtpreventivo" class="form-control" id="txtpreventivo" value="" maxlength="65" style="text-transform:uppercase;" >
                    </div>
                  </div>
                </div>
                <!-- /.col-lg-12 (nested) -->
                  ...
                  <label class="col-lg-1 control-label">Fecha A.:</label>
                    <div class="col-lg-5">
                      <div class='input-group date' id='txtfecest'>
                        <input type='text' class="form-control" name="txtfecest"  value=""/>
                        <span class="input-group-addon">
                          <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                      </div>
                    ...
                    <div class="col-lg-5">
                      <input name="txtobsa" class="form-control" id="txtobsa" value="" maxlength="65" style="text-transform:uppercase;">
                    </div>
                  </div>
                </div>
              </div>
