...
if($_POST){	
  ...
  if($txtspart!=""){
	...
	header('Location:pdfrep2.php?criterio='.base64_encode($criterio).'&cripart='.base64_encode($cripart).'&orden='.$cborden);	
}
?>
<!DOCTYPE html>
<html>
...
<div id="wrapper"> 
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header">Cargo y Descargo SIGEP - Fecha y días Transcurridos</h3>
      </div>
      <!-- /.col-lg-12 --> 
    </div>
    <!-- /.row -->
    <div class="row">
      <form role="form" class="form-horizontal" action="formcrirep2.php" method="post" target="_blank">
        <div class="col-lg-8">
